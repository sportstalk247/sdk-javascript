...
var ChatClient = /** @class */ (function () {
    ...
    ChatClient.init = function (config, eventHandlers) {
        ...
        var client = new ChatClient(config);
...
var RestfulChatEventService = /** @class */ (function () {
    ...
    function RestfulChatEventService(config, eventHandlers) {
        ...
        this.setConfig = function (config) {
            ...
            _this._apiHeaders = utils_1.getUrlEncodedHeaders(_this._config.apiToken);
            _this._jsonHeaders = utils_1.getJSONHeaders(_this._config.apiToken);
...
},{"../../../models/ChatModels":16,"../../constants/api":11,"../../constants/messages":12,"../../errors":13,"../../network":14,"../../utils":15,"_process":51}],4:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var RestfulChatModerationService = /** @class */ (function () {
    ...
    RestfulChatModerationService.prototype.setConfig = function (config) {
        ...
        this._jsonHeaders = utils_1.getJSONHeaders(this._config.apiToken);
    };
...
},{"../../../models/ChatModels":16,"../../constants/api":11,"../../errors":13,"../../network":14,"../../utils":15}],10:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.PUT = exports.DELETE = exports.GET = exports.POST = exports.DEFAULT_CONFIG = exports.CONTENT_TYPE = exports.API_SUCCESS_MESSAGE = exports.API_TOKEN_HEADER = exports.APPLICATION_JSON = exports.FORM_ENCODED = exports.DEFAULT_ENDPOINT = void 0;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.forceObjKeyOrString = exports.getJSONHeaders = exports.getUrlEncodedHeaders = exports.buildAPI = exports.formify = void 0;
var api_1 = require("./constants/api");
var errors_1 = require("./errors");
 ...
 * @param apiKey
 */
function getUrlEncodedHeaders(apiKey) {
    var headers = {
...
},{"./adapters/http":23,"./adapters/xhr":23,"./core/enhanceError":33,"./helpers/normalizeHeaderName":45,"./utils":49,"_process":51}],38:[function(require,module,exports){
'use strict';
